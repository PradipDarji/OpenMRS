package com.openmrs.commonutilitiesmethods;
...
public class CommonUtilitiesMethods extends BaseTest {
    ...
    public boolean clickOnButton(WebDriver driver, WebElement ele) {
        try {
            WebElement clickActionOnButton = (new WebDriverWait(driver, 30)).until(ExpectedConditions.visibilityOf(ele));
            if (clickActionOnButton.isDisplayed()) {
                clickActionOnButton.click();
                return true;
            } else {
